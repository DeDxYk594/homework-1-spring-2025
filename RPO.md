...
- [ ] Пользователь, не имеющий доступа к доске, может просмотреть карточку по ссылке на карточку [найден баг](#201)</a>
...
- [ ] Администратор или редактор могут удаляьть назначенных пользователей из карточки [найден баг](#401)
...
- [ ] Настройка тегов доски. При вводе данных не проходящих валидацию выводится соответствующая ошибка. При корректном вводе тег корректно отображается в списке.  [найден баг](#1201)</a>  
...
<h4 id="201">Баг 201</h4>


![image](images/201_1.png)
