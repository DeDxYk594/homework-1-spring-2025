...
должно произойти. Если он изменился и новый текст по длине не меньше 3 и не больше 30 символов, должно отобразиться Toast-сообщение.
[найден баг](#1901)
...
* Пароль должен содержать специальный символ: <code>!#&.,?/\\(){}[]\"'`;:|<>*^%~</code>
